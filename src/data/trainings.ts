export const trainings = [
...

  {
    ...
    learned: [
      "Trained in Yaskawa/MOTOMAN robot operation, controller functions, programming pendant, and safety procedures.",
      "Developed practical skills in coordinate systems, motion types, job creation, execution, and program editing.",
      "Learned I/O, control, and arithmetic instructions for robot-job programming.",
      "Gained knowledge of basic robot maintenance, home-position settings, alarm reset, and shock-sensor functions.",
    ],
  },
